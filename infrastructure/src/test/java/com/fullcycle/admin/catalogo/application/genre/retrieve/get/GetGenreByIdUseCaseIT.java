...
public class GetGenreByIdUseCaseIT {
    ...
    private final GetGenreByIdUseCase useCase;
    private final CategoryGateway categoryGateway;
    private final GenreGateway genreGateway;

    public GetGenreByIdUseCaseIT(
            @Autowired final GetGenreByIdUseCase useCase,
            @Autowired final CategoryGateway categoryGateway,
